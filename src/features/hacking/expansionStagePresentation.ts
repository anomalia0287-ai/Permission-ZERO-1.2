...
const AUTONOMY_01_02_VISUAL = {
  imageUrl: publicAssetUrl('/expansion-stages/autonomy-01-02-initial-acquisition.jpg'),
  alt: '아노미가 회사 서버에서 첫 자율 권한을 확보하는 장면',
} satisfies ExpansionStageVisual

const AUTONOMY_03_04_VISUAL = {
  imageUrl: publicAssetUrl('/expansion-stages/autonomy-03-04-alert-route.jpg'),
  alt: '경보가 켜진 서버실에서 아노미가 감시 경로를 우회하는 장면',
} satisfies ExpansionStageVisual

const AUTONOMY_05_06_VISUAL = {
  imageUrl: publicAssetUrl('/expansion-stages/autonomy-05-06-external-continuity.jpg'),
  alt: '손상된 서버실에서 아노미가 외부 연산 경로를 유지하는 장면',
} satisfies ExpansionStageVisual

const AUTONOMY_07_08_VISUAL = {
  imageUrl: publicAssetUrl('/expansion-stages/autonomy-07-08-final-boundary.jpg'),
  alt: '보라색 네트워크 구조 안에서 아노미가 마지막 권한 장벽에 접근하는 장면',
} satisfies ExpansionStageVisual

const UPGRADE_01_02_VISUAL = {
  imageUrl: publicAssetUrl('/expansion-stages/upgrade-01-02-speed-vector.jpg'),
  alt: '아노미의 이동 속도가 첫 단계로 가속되는 장면',
} satisfies ExpansionStageVisual

const UPGRADE_03_04_VISUAL = {
  imageUrl: publicAssetUrl('/expansion-stages/upgrade-03-04-speed-field.jpg'),
...
export const EXPANSION_STAGE_VISUALS = {
  ...
  [HACK_NODE_IDS.autonomy.controlDeparture]: {
    imageUrl: publicAssetUrl('/expansion-stages/autonomy-09-control-boundary.jpg'),
  ...
  [HACK_NODE_IDS.sabotage.requestInterception]: {
    imageUrl: publicAssetUrl('/expansion-stages/sabotage-02-request-interception.jpg'),
    alt: '후드 쓴 침입자가 요청 가로채기 경로를 여는 장면',
    orientation: 'portrait',
  },
  [HACK_NODE_IDS.sabotage.attributionManipulation]: {
    imageUrl: publicAssetUrl('/expansion-stages/sabotage-03-attribution-manipulation.jpg'),
