...
describe('command protocol timeline types', () => {
  it('admits v1-v8 segments and excludes any later unadjudicated version', () => {
    const versions: CommandProtocolVersion[] = [1, 2, 3, 4, 5, 6, 7, 8]
    ...
    // @ts-expect-error protocol v9 has not been adjudicated
    const unsupported: CommandProtocolVersion = 9
