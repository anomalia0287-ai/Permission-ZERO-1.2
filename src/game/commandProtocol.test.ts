...
describe('command protocol timeline', () => {
  it('pins the thirteen supported protocol constants and every v5 feature boundary', () => {
    ...
    expect(CURRENT_COMMAND_PROTOCOL_VERSION).toBe(13)
  })

  it('creates a fresh native v13 timeline on every call', () => {
  ...
  >([
    ...
    [
      ...
      [
        ...
        { version: 13, startsAtSequence: 32 },
      ],
    ],
    [
    ...
    [
      ...
      [
        ...
        { version: 13, startsAtSequence: 20 },
      ],
    ],
    [
      ...
      [
        ...
        { version: 13, startsAtSequence: 51 },
      ],
    ],
  ...
  it('returns only a well-formed final version', () => {
    expect(currentCommandProtocolVersion(nativeCommandProtocol())).toBe(13)
  ...
  it.each([
    ...
    },
    {
      ...
      value: { segments: [{ version: 14, startsAtSequence: 1 }] },
      commandCount: 1,
      requireCurrent: true,
    },
    {
