...
describe('versioned campaign saves', () => {
  ...
  it('migrates a valid v10 intrusion checkpoint and promotes future commands to protocol 12', () => {
    ...
    expect(decoded.envelope.commandProtocol).toEqual({
      segments: [
        ...
        { version: 13, startsAtSequence: legacy.commandSequence + 1 },
      ],
    })
  })
  ...
  it.each([
    ...
    [2, 0, 0, '13@1'],
    [2, 19, 0, '2@1;13@20'],
    [2, 50, 31, '1@1;2@32;13@51'],
    [3, 50, 31, '1@1;2@32;13@51'],
    [4, 50, 31, '1@1;2@32;13@51'],
    [5, 50, 31, '1@1;2@32;13@51'],
    [6, 50, 31, '1@1;2@32;13@51'],
  ] as const)(
  ...
  it('keeps zero-command v1 and v2 provenance distinct after both migrate to 13@1', () => {
